...
- [x] VenueDetail core queries migrated (venueBySlug, rating, ops reads).
- [x] Feed migrated to React Query (useInfiniteQuery).
- [x] CatchDetail migrated to React Query.
- [x] Profile migrated to React Query.
- [x] Notifications surfaces migrated to React Query (bell + profile section).
- [ ] Shared cache policy documented + enforced beyond VenueDetail.
