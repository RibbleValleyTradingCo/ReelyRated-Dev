-- 70_0006_profile_follows_SELECT_RELATIONSHIP.sql
-- Compare PERMISSIVE SELECT policies on public.profile_follows for redundancy/overlap.
...
with policies as (
  ...
  where p.schemaname = 'public'
    and p.tablename = 'profile_follows'
    and p.cmd = 'SELECT'
),
roles_flat as (
  select
