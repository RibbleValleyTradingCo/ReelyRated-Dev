...
-- Red-flag grant patterns limited to the public schema (app-controlled surface).
-- After P0, expect no PUBLIC CREATE in public, no PUBLIC writes in public,
-- and only intended anon/auth writes (ideally shrinking over time).
