...
3) **Suspended (future suspension_until):** Attempt to post → blocked; toast: “You’re currently suspended…”, includes “until <date>” when available.
4) **Suspended (past suspension_until):** Treated as active; comments succeed.
5) **Banned user:** Attempt to post → blocked; toast: “Your account is banned…”.
...
3) **Suspended (future suspension_until):** Attempt to create → blocked; toast: “You’re currently suspended…”.
4) **Suspended (past suspension_until):** Treated as active; catch creation succeeds.
5) **Banned user:** Attempt to create → blocked; toast: “Your account is banned…”.
