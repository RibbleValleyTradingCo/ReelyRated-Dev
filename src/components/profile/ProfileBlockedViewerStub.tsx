        ...
        <Card className="mx-auto max-w-2xl rounded-2xl">
          <CardContent className="space-y-4 px-6 py-6">
            <div className="space-y-1">
              <h1 className="text-2xl font-semibold text-foreground">This angler isn&apos;t available.</h1>
              <p className="text-sm text-muted-foreground">You can&apos;t view this angler&apos;s profile.</p>
            </div>
