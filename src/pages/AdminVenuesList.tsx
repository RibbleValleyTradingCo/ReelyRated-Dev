            ...
            {loading ? (
              ...
              <div className="space-y-3">
                {venues.map((venue) => (
                  <Card
                    key={venue.id}
                    className="flex flex-col border border-slate-200 bg-white shadow-sm transition hover:shadow-md w-full"
                  >
                    <CardHeader className="flex min-w-0 flex-col gap-3 pb-2 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                      <div className="space-y-1 min-w-0">
                        <CardTitle className="text-lg font-semibold text-slate-900 truncate">{venue.name}</CardTitle>
                    ...
                    <CardContent className="flex flex-wrap items-center gap-2 sm:gap-4 pb-5 text-sm text-slate-600 min-w-0">
