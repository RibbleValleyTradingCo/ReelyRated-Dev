-- 2039_enable_mention_notifications.sql
-- Purpose: restore mention notifications in create_comment_with_rate_limit while preserving admin bypass and new_comment behaviour.

SET search_path = public, extensions;

-- Drop any old overload (idempotent).
