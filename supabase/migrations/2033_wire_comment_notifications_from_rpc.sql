-- 2033_wire_comment_notifications_from_rpc.sql
-- (Moved from 2026_wire_comment_notifications_from_rpc.sql to resolve duplicate version)
-- Purpose: ensure create_comment_with_rate_limit sends new_comment notifications and remove stale overloads.
