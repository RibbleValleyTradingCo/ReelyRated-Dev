-- 2127_harden_venue_catch_rpcs_public_only.sql
-- Purpose: Ensure venue catch RPCs return public-only catches regardless of caller.

SET search_path = public, extensions;

-- Recreate venue recent catches RPC with explicit public visibility filter.
...
-- Recreate venue top catches RPC with explicit public visibility filter.
