-- 2102_fix_weight_unit_case_in_venue_rpcs.sql
-- Recreate venue RPCs with safe weight_unit handling to avoid enum cast errors.

SET search_path = public, extensions;

-- Recreate venue recent catches RPC with text-based comparison for weight_unit.
...
-- Recreate venue top catches RPC with text-based comparison for weight_unit.
